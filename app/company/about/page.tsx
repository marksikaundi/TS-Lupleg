        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
            <div>
              ...
              <p className="text-gray-600">
                ...
                creation by making AI-powered optimization accessible to
                creators worldwide. We believe that every creator deserves the
                tools to maximize their content&apos;s potential and reach their
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="p-6 bg-gray-50 rounded-lg">
                ...
                <p className="text-gray-600">
                  We prioritize the needs of creators, building tools that
          ...
          <div>
            ...
            <p className="text-gray-600 mb-8">
              Whether you&apos;re a seasoned content creator or just starting
              out, Promptly is here to help you achieve your content goals. Join
              thousands of creators who are already using our platform to
              optimize their content and grow their audience.
            </p>
