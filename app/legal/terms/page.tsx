        ...
        <div className="space-y-8">
          ...
          <section>
            ...
            <p className="text-gray-700">
              ...
              provide accurate information and maintain its accuracy. You are
          ...
          <section>
            ...
            <ul className="list-disc pl-6 text-gray-700 space-y-2">
              ...
              <li>
                You will not violate any laws or third-party rights when using
                our Service.
              </li>
              <li>
          ...
          <section>
            ...
            <p className="text-gray-700">
              ...
              are owned by Promptly and are protected by international
          ...
          <section>
            ...
            <p className="text-gray-700">
              ...
              access to our Service immediately, without prior notice, for any
              violation of these Terms or for any other reason we deem
              appropriate.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700">
              To the maximum extent permitted by law, Promptly shall not be
